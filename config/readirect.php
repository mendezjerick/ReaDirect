...
return [
    ...
    'tts' => [
        ...
        'cache_bypass' => filter_var(env('TTS_CACHE_BYPASS', false), FILTER_VALIDATE_BOOLEAN),
        ...
        'expressive' => [
            ...
            'reference_high_priority_min_seconds' => (float) env('TTS_REFERENCE_HIGH_PRIORITY_MIN_SECONDS', 7.0),
            'reference_medium_priority_min_seconds' => (float) env('TTS_REFERENCE_MEDIUM_PRIORITY_MIN_SECONDS', 4.0),
            'cache_root' => env('TTS_CACHE_ROOT', 'storage/tts/cache'),
            'comparison_output_root' => env('TTS_COMPARISON_OUTPUT_ROOT', 'storage/tts/cache/comparisons'),
        ],
        'voices' => [
        ...
        'humanization' => [
            ...
            'auto_prompt_extension_enabled' => filter_var(env('TTS_AUTO_PROMPT_EXTENSION_ENABLED', false), FILTER_VALIDATE_BOOLEAN),
            'curated_prompts_enabled' => filter_var(env('TTS_CURATED_PROMPTS_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
            'curated_prompt_target_seconds' => (float) env('TTS_CURATED_PROMPT_TARGET_SECONDS', 7.0),
            'curated_prompt_min_seconds' => (float) env('TTS_CURATED_PROMPT_MIN_SECONDS', 6.0),
            'curated_prompt_max_seconds' => (float) env('TTS_CURATED_PROMPT_MAX_SECONDS', 9.0),
    ...
    'voice_database' => [
        'enabled' => filter_var(env('READIRECT_VOICE_DATABASE_MODE', true), FILTER_VALIDATE_BOOLEAN),
        'strict' => filter_var(env('READIRECT_VOICE_DATABASE_STRICT', false), FILTER_VALIDATE_BOOLEAN),
        'two_stage_generation' => filter_var(env('READIRECT_TTS_TWO_STAGE_GENERATION', true), FILTER_VALIDATE_BOOLEAN),
        'stage1_reference_style_enabled' => filter_var(env('READIRECT_TTS_STAGE1_REFERENCE_STYLE_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
        'stage2_kokoro_identity_enabled' => filter_var(env('READIRECT_TTS_STAGE2_KOKORO_IDENTITY_ENABLED', true), FILTER_VALIDATE_BOOLEAN),
        'active_stage' => env('READIRECT_TTS_ACTIVE_STAGE', 'reference_style'),
        'defense_audio_type' => env('READIRECT_TTS_DEFENSE_AUDIO_TYPE', 'reference_style'),
        'stage2_demo_audio_type' => env('READIRECT_TTS_STAGE2_DEMO_AUDIO_TYPE', 'kokoro_identity'),
