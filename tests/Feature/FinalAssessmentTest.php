    ...
    public function test_completion_screen_recovers_completed_final_attempt_without_session_and_shows_safe_summary(): void
    {
        ...
        $this->withSession(['learner_id' => $learner->id])
            ...
            ->assertInertia(fn (Assert $page) => $page
                ...
                ->where('agentMessages.0.message', 'Great work. You completed your reading assessments, and you stayed focused through each step.')
                ->where('agentMessages.1.name', 'Miss Ciel')
                ->where('agentMessages.1.message', 'Nice work! You practiced carefully, kept going through tricky parts, and used your clear reading voice.')
