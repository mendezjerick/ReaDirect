...
import { ArrowRight, BookOpen, Mic, HelpCircle, Volume2, RotateCcw } from 'lucide-vue-next';
...
<template>
    <LearnerLayout :progress="70" diagnostic-step="sentence-reading" :has-bottom-bar="false">
        <!-- No #agent slot — landscape layout, full control -->

        <div class="ri-landscape">

            <!-- LEFT: Miss Vivian -->
            <div class="ri-agent ri-anim flex flex-col items-center" style="--ri-delay: 0ms">
                <!-- Avatar -->
                <div class="ri-agent-avatar">
                    <AgentVideoPlayer
                        agent="assessment"
            ...
            <div class="ri-content">
                ...
                <!-- CTA Button -->
                <div class="mt-4 ri-anim" style="--ri-delay: 200ms">
                    <Link href="/learner/diagnostic/story-selection" class="w-full">
