            ...
            <form @submit.prevent="updateProfile" class="space-y-5">
                ...
                <div class="flex justify-end pt-2">
                    <button
                        ...
                        class="inline-flex w-full sm:w-auto items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-2.5 text-sm font-bold text-white transition-all duration-200 hover:bg-orange-600 hover:shadow-md hover:shadow-orange-500/20 active:scale-[0.97] disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                        <Save class="size-4" />
