...
<template>
    <AdminLayout>
        ...
        <div class="grid gap-4 md:grid-cols-4"><DashboardCard><h2 class="font-black">Learners</h2><p class="text-3xl font-black text-primary">{{ learnersCount }}</p><Link href="/admin/testing/learners" class="mt-3 inline-block font-black text-primary">Select learner</Link></DashboardCard><DashboardCard><h2 class="font-black">Assessment attempts</h2><p class="text-3xl font-black text-primary">{{ sandboxAssessments.length }}</p></DashboardCard><DashboardCard><h2 class="font-black">Module attempts</h2><p class="text-3xl font-black text-primary">{{ sandboxModules.length }}</p></DashboardCard><DashboardCard><h2 class="font-black">True Sandbox</h2><p class="mt-2 text-sm font-bold text-muted">Direct ASR testing without learner progression.</p><Link href="/admin/testing/true-sandbox" class="mt-3 inline-block font-black text-primary">Open True Sandbox</Link></DashboardCard></div>
