    ...
    <AdminLayout>
        ...
        <DashboardCard class="mb-6 prof-card-in">
            ...
            <div class="mb-6 flex items-center gap-4">
                <div class="flex h-[72px] w-[72px] shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-primary to-blue-600 text-white text-3xl font-extrabold shadow-lg shadow-primary/20 ring-4 ring-primary/5">
                ...
                <div class="min-w-0">
                    ...
                    <div class="mt-2 flex flex-wrap gap-1.5">
                        <span
                            v-for="role in roles"
                            :key="role"
                            class="inline-flex items-center gap-1.5 rounded-full bg-blue-50 px-2.5 py-1 text-[11px] font-bold capitalize tracking-wide text-primary ring-1 ring-primary/20 whitespace-nowrap"
                        >
                            <Shield class="size-3" />
                            {{ role.replace('_', ' ') }}
                        </span>
