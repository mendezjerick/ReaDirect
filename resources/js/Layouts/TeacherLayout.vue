                            ...
                            >
                                ...
                                <div class="mb-3 flex items-center justify-between px-1">
                                    <div>
                                        ...
                                        <p class="text-[11px] text-muted">Class updates and reminders</p>
                                    </div>
                                    <span class="rounded-full bg-orange-50 px-2.5 py-1 text-[11px] font-bold text-orange-600">{{ notifications.length }}</span>
                                </div>
...
const notifications = [
    {
        id: 'placeholder-1',
        title: 'Learner graph ready',
        message: 'Learner reading graph is now visible on the dashboard. Real score history can be connected next.',
        time: 'now',
    },
    {
        id: 'placeholder-2',
        title: 'Assessment reminders',
        message: 'Diagnostic and reassessment alerts will appear here once live notification data is connected.',
        time: 'demo',
    },
];
