...
class VoiceLineCatalog
{
    ...
    public function staticLines(): array
    {
        return [
            ...
            $this->line('ciel.module3.comma_pause_reading.01', 'ciel', 'focused_instruction', 'Read the sentence and make a small pause at the comma.', 'Advanced Module lesson 1 instruction cycle 1', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.comma_pause_reading.02', 'ciel', 'focused_instruction', 'When you see the comma, pause just a little, then keep reading.', 'Advanced Module lesson 1 instruction cycle 2', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.comma_pause_reading.03', 'ciel', 'focused_instruction', 'Read smoothly and remember the small comma pause.', 'Advanced Module lesson 1 instruction cycle 3', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.full_stop_pause_reading.01', 'ciel', 'focused_instruction', 'Read both sentences and pause after the full stop.', 'Advanced Module lesson 2 instruction cycle 1', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.full_stop_pause_reading.02', 'ciel', 'focused_instruction', 'When the sentence ends, make a stronger pause before reading the next one.', 'Advanced Module lesson 2 instruction cycle 2', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.full_stop_pause_reading.03', 'ciel', 'focused_instruction', 'Read the two sentences clearly, with a full-stop pause between them.', 'Advanced Module lesson 2 instruction cycle 3', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.mixed_punctuation_fluency.01', 'ciel', 'focused_instruction', 'Read the full text smoothly. Pause at the comma and full stop.', 'Advanced Module lesson 3 instruction cycle 1', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.mixed_punctuation_fluency.02', 'ciel', 'focused_instruction', 'Read carefully and use the punctuation to guide your pacing.', 'Advanced Module lesson 3 instruction cycle 2', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            $this->line('ciel.module3.mixed_punctuation_fluency.03', 'ciel', 'focused_instruction', "Let's read this smoothly, with clear pauses and steady pacing.", 'Advanced Module lesson 3 instruction cycle 3', 'resources/js/Pages/Learner/Modules/ModuleActivity.vue'),
            ...
            $this->line('ciel.module3.overview.comma_pause_reading', 'ciel', 'focused_instruction', 'This lesson has a comma in the sentence. When you reach it, make a tiny pause, then keep reading.', 'Advanced Module overview lesson hover', 'app/Services/ModuleExperienceService.php'),
            $this->line('ciel.module3.overview.full_stop_pause_reading', 'ciel', 'focused_instruction', 'This lesson uses two sentences. Pause when the first sentence ends, then begin the next sentence clearly.', 'Advanced Module overview lesson hover', 'app/Services/ModuleExperienceService.php'),
            $this->line('ciel.module3.overview.mixed_punctuation_fluency', 'ciel', 'focused_instruction', 'This lesson mixes commas and full stops. Read every word clearly, and let the marks guide your pauses.', 'Advanced Module overview lesson hover', 'app/Services/ModuleExperienceService.php'),
