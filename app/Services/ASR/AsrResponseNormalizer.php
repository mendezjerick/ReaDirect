...
class AsrResponseNormalizer
{
    ...
    public function normalize(?array $aiResponse, ?string $fallbackTranscript = null): array
    {
        ...
        return [
            ...
            'gop_supported' => $aiResponse['gop_supported'] ?? null,
            'gop_score' => $aiResponse['gop_score'] ?? null,
            'overall_gop_score' => $aiResponse['overall_gop_score'] ?? $aiResponse['gop_score'] ?? null,
            'gop_confidence' => $aiResponse['gop_confidence'] ?? null,
            'acoustic_confidence' => $aiResponse['acoustic_confidence'] ?? null,
            ...
            'canonical_phonemes' => $aiResponse['canonical_phonemes'] ?? $aiResponse['canonical_expected_phonemes'] ?? $aiResponse['gop_expected_phonemes'] ?? [],
            'canonical_expected_phonemes' => $aiResponse['canonical_expected_phonemes'] ?? $aiResponse['gop_expected_phonemes'] ?? [],
            'gop_observed_phonemes' => $aiResponse['gop_observed_phonemes'] ?? [],
            'decoded_phonemes' => $aiResponse['decoded_phonemes'] ?? $aiResponse['decoded_acoustic_phonemes'] ?? $aiResponse['gop_observed_phonemes'] ?? [],
            'decoded_acoustic_phonemes' => $aiResponse['decoded_acoustic_phonemes'] ?? $aiResponse['gop_observed_phonemes'] ?? [],
            'gop_phoneme_scores' => $aiResponse['gop_phoneme_scores'] ?? [],
            'phoneme_scores' => $aiResponse['phoneme_scores'] ?? $aiResponse['gop_phoneme_scores'] ?? [],
            ...
            'weak_phoneme' => $aiResponse['weak_phoneme'] ?? $aiResponse['lowest_phoneme'] ?? null,
            'weak_phoneme_score' => $aiResponse['weak_phoneme_score'] ?? $aiResponse['lowest_phoneme_score'] ?? null,
            'lowest_phoneme' => $aiResponse['lowest_phoneme'] ?? $aiResponse['weak_phoneme'] ?? null,
            'lowest_phoneme_score' => $aiResponse['lowest_phoneme_score'] ?? $aiResponse['weak_phoneme_score'] ?? null,
            'nearest_confusion' => $aiResponse['nearest_confusion'] ?? null,
            'alignment_quality' => $aiResponse['alignment_quality'] ?? null,
            'gop_model_version' => $aiResponse['gop_model_version'] ?? null,
            'gop_model_path' => $aiResponse['gop_model_path'] ?? null,
            'gop_frame_count' => $aiResponse['gop_frame_count'] ?? null,
            'gop_duration_seconds' => $aiResponse['gop_duration_seconds'] ?? null,
            'gop_fallback_used' => $aiResponse['gop_fallback_used'] ?? null,
